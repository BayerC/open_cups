...
- [requirements.txt](requirements.txt): Auto-generated from [uv.lock](uv.lock) for deployment compatibility (e.g., Streamlit Cloud). DO NOT edit manually - it's regenerated by pre-commit hooks. Committed to version control for deployment platforms that don't support [uv](https://docs.astral.sh/uv) natively.
