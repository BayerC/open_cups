...
- [Google NotebookLM](https://notebooklm.google.com/) is a great tool for AI generated "one-pager" ("Infographic") or slides ("Slide Deck").
Note that one can customize the prompt using the edit symbol.
